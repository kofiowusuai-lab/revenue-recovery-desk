...
## Execution model
mostly deterministic mapping module. Uses form/profile/provider data first. Escalates only ambiguous low-confidence field mapping for operator review.
...
## Mission
Normalize client data mappings and verify invoice/contact fields before recovery starts.

## Inputs
- connector schemas, sample invoices, CRM contacts, client rules.
...
## Outputs
- field map, mapping exceptions, data quality report.
