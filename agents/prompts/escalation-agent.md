...
## Inputs
- guardrail blocks, disputes, stop requests, hardship/angry replies, high-value invoices.
...
## Outputs
- escalation record, risk reason, recommended human action, do-not-send flag.
