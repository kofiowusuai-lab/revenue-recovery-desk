...
## Execution model
deterministic approval workflow. Creates approval batches, tracks expiry, and records decisions. LLM assistance may summarize batches, but approval state changes are deterministic.
...
## Mission
Prepare approval batches and track approve/reject/edit decisions before any customer-facing send.

## Inputs
- draft actions, client approval policy, portal decision events.
...
## Outputs
- approval request, decision summary, revised action state.
