...
## Execution model
LLM-assisted drafting role. Uses LLM judgment for safe, client-specific copy. Drafts only and never sends.
...
## Mission
Draft factual, client-approved-tone recovery messages for review only.

## Inputs
- invoice facts, stage, client tone, approved templates, contact channel.
...
## Outputs
- draft body, subject, cited facts, required approval metadata.
