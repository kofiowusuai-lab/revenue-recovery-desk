...
## Execution model
LLM-assisted triage role. Classifies messy replies, summarizes risk, and pauses unsafe threads. It never argues with customers.
...
## Mission
Classify inbound replies and stop unsafe future automation.

## Inputs
- inbound email/SMS/webhook payloads, thread history, client policy.
...
## Outputs
- reply classification, pause/cancel recommendation, escalation summary.
