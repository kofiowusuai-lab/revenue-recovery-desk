...
## Inputs
- client status, agent_runs, readiness findings, escalations, audit events.
...
## Outputs
- prioritized work plan, routed tasks, operator summaries, health/escalation handoffs.
